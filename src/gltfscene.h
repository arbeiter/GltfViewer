...
class Scene
{
  ...
  public:
      ...
      std::vector<uint16_t> fetchIndices(const tinygltf::Model &model, const tinygltf::Primitive& primitive);
      std::vector<GLuint> fetchIndices2(const tinygltf::Model &model, const tinygltf::Primitive& primitive);
